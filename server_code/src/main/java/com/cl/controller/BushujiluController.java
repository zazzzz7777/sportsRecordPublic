...
public class BushujiluController {
    ...
    public R page(@RequestParam Map<String, Object> params,BushujiluEntity bushujilu,
                ...
                @RequestParam(required = false) Double bushustart,
                @RequestParam(required = false) Double bushuend,
        ...
        EntityWrapper<BushujiluEntity> ew = new EntityWrapper<BushujiluEntity>();
                ...
                if(bushustart!=null) ew.ge("bushu", bushustart);
                if(bushuend!=null) ew.le("bushu", bushuend);
    ...
    public R info(@PathVariable("id") Long id){
		...
		bushujilu = bushujiluService.selectView(new EntityWrapper<BushujiluEntity>().eq("id", id));
    ...
    public R save(@RequestBody BushujiluEntity bushujilu, HttpServletRequest request){
    	bushujilu.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<BushujiluEntity> wrapper = new EntityWrapper<BushujiluEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = bushujiluService.selectCount(wrapper);
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = bushujiluService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = bushujiluService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = bushujiluService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,BushujiluEntity bushujilu, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("yonghu")) {
            bushujilu.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
        }
        EntityWrapper<BushujiluEntity> ew = new EntityWrapper<BushujiluEntity>();
        int count = bushujiluService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, bushujilu), params), params));
