...
const detailList = data
    let  objtemp= {
detailList,
shipinleixing: data.shipinleixing,
    }
...
const obj={
    shipinleixing: this.data. shipinleixing,
}
...
return
    ...
    this.data.cross ? (crossrefid = this.data.id, crossuserid =this.data.userid) : ""
        ...
        if(crossrefid && crossuserid) {
            ...
            let corssRes = await list(`shipinleixing`, params)
            crossoptnum = wx.getStorageSync('statusColumnName');
...
if (ruleForm.id ) {
 await update(`shipinleixing`, ruleForm)
}
else {
await add(`shipinleixing`, ruleForm)
            }
        }
